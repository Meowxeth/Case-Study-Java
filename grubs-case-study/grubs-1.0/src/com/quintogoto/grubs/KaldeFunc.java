...
public class KaldeFunc {
    ...
    public void kaldeFunc(JLayeredPane layeredPane, JButton kaldeButton, JScrollPane scrollPane, JButton bicolexButton, JButton siniButton, JButton cokeButton, JButton adoboButton, JButton gulamButton, JLabel drinksLabel, JButton cancelButton, JButton checkoutButton, JLabel ordersLabel, JLabel ordersQuantLabel) {
        kaldeButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                init.removeMenu(layeredPane, adoboButton, siniButton, bicolexButton, kaldeButton, gulamButton, cokeButton, drinksLabel);

                ImageIcon kaldeChosen = new ImageIcon("Case-Study-Java/grubs-case-study/grubs-1.0/resources/assets/cards/chosen-kalder.png");
                ...
                confirm(layeredPane, confirmButton, addButton, minusButton, backgroundLabel, kaldeButton, bicolexButton, siniButton, cokeButton, adoboButton, gulamButton, drinksLabel, returnButton, cancelButton, checkoutButton, ordersLabel, ordersQuantLabel);
                returnBtn(layeredPane, confirmButton, addButton, minusButton, backgroundLabel, adoboButton, bicolexButton, kaldeButton, gulamButton, cokeButton, siniButton, drinksLabel, returnButton, cancelButton, checkoutButton, ordersLabel, ordersQuantLabel);
    ...
    public void confirm(JLayeredPane layeredPane, JButton confirmButton, JButton addButton, JButton minusButton, JLabel backgroundLabel, JButton kaldeButton, JButton bicolexButton, JButton siniButton, JButton cokeButton, JButton adoboButton, JButton gulamButton, JLabel drinksLabel, JButton returnButton, JButton cancelButton, JButton checkoutButton, JLabel ordersLabel, JLabel ordersQuantLabel){
