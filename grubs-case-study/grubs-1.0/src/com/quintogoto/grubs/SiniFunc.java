...
public class SiniFunc {
    ...
    public void siniFunc(JLayeredPane layeredPane, JButton siniButton, JScrollPane scrollPane, JButton kaldeButton, JButton bicolex, JButton cokeButton, JButton adoboButton, JButton gulamButton, JLabel drinksLabel, JButton cancelButton, JButton checkoutButton, JLabel ordersLabel, JLabel ordersQuantLabel) {
        siniButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                init.removeMenu(layeredPane, adoboButton, siniButton, bicolex, kaldeButton, gulamButton, cokeButton, drinksLabel);

                ImageIcon siniChosen = new ImageIcon("Case-Study-Java/grubs-case-study/grubs-1.0/resources/assets/cards/chosen-sini.png");
                ...
                confirm(layeredPane, confirmButton, addButton, minusButton, backgroundLabel, siniButton, kaldeButton, bicolex, cokeButton, adoboButton, gulamButton, drinksLabel, returnButton, cancelButton, checkoutButton, ordersLabel, ordersQuantLabel);
                returnBtn(layeredPane, confirmButton, addButton, minusButton, backgroundLabel, adoboButton, bicolex, kaldeButton, gulamButton, cokeButton, siniButton, drinksLabel, returnButton, cancelButton, checkoutButton, ordersLabel, ordersQuantLabel);
    ...
    public void confirm(JLayeredPane layeredPane, JButton confirmButton, JButton addButton, JButton minusButton, JLabel backgroundLabel, JButton siniButton, JButton kaldeButton, JButton bicolex, JButton cokeButton, JButton adoboButton, JButton gulamButton, JLabel drinksLabel, JButton returnButton, JButton cancelButton, JButton checkoutButton, JLabel ordersLabel, JLabel ordersQuantLabel){
