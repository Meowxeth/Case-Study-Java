...
public class GulamFunc {
    ...
    public void gulamFunc(JLayeredPane layeredPane, JButton gulamButton, JScrollPane scrollPane, JButton bicolexButton, JButton kalderButton, JButton cokeButton, JButton adoboButton, JButton siniButton, JLabel drinksLabel, JButton cancelButton, JButton checkoutButton, JLabel ordersLabel, JLabel ordersQuantLabel) {
        gulamButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                ImageIcon gulamChosen = new ImageIcon("Case-Study-Java/grubs-case-study/grubs-1.0/resources/assets/cards/chosen-gulaman.png");
                ...
                confirm(layeredPane, confirmButton, addButton, minusButton, backgroundLabel, scrollPane, gulamButton, bicolexButton, kalderButton, cokeButton, adoboButton, siniButton, drinksLabel, returnButton, cancelButton, checkoutButton, ordersLabel, ordersQuantLabel);
                returnBtn(layeredPane, confirmButton, addButton, minusButton, backgroundLabel, adoboButton, bicolexButton, kalderButton, gulamButton, cokeButton, siniButton, drinksLabel, returnButton, cancelButton, checkoutButton, ordersLabel, ordersQuantLabel);
    ...
    public void confirm(JLayeredPane layeredPane, JButton confirmButton, JButton addButton, JButton minusButton, JLabel backgroundLabel, JScrollPane scrollPane, JButton gulamButton, JButton bicolexButton, JButton kalderButton, JButton cokeButton, JButton adoboButton, JButton siniButton, JLabel drinksLabel, JButton returnButton, JButton cancelButton, JButton checkoutButton, JLabel ordersLabel, JLabel ordersQuantLabel){
