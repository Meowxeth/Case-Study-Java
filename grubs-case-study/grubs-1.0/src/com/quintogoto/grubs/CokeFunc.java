...
public class CokeFunc {
    ...
    public void cokeFunc(JLayeredPane layeredPane, JButton cokeButton, JScrollPane scrollPane, JButton bicolexButton, JButton kalderButton, JButton gulamButton, JButton adoboButton, JButton siniButton, JLabel drinksLabel, JButton cancelButton, JButton checkoutButton, JLabel ordersLabel, JLabel ordersQuantLabel) {
        cokeButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                ImageIcon cokeChosen = new ImageIcon("Case-Study-Java/grubs-case-study/grubs-1.0/resources/assets/cards/chosen-coke.png");
                ...
                confirm(layeredPane, confirmButton, addButton, minusButton, backgroundLabel, scrollPane, cokeButton, bicolexButton, kalderButton, gulamButton, adoboButton, siniButton, drinksLabel, returnButton, cancelButton, checkoutButton, ordersLabel, ordersQuantLabel);
